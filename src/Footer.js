        ...
        <div className="flex flex-col md:flex-row min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
            ...
            <div className="md:hidden bg-white dark:bg-gray-800 shadow p-4 flex items-center justify-between">
                <button
                    ...
                    className="p-2 text-gray-600 dark:text-gray-400 hover:text-#0986e9"
                >
            ...
            <div className={`fixed md:relative z-30 md:z-auto w-64 bg-white dark:bg-gray-800 shadow-md transform transition-transform duration-300 ease-in-out 
                ...
                <div className="p-4 border-b border-gray-200 dark:border-gray-700 md:hidden">
                    <button
                        ...
                        className="text-gray-600 dark:text-gray-400 hover:text-#0986e9"
                    >
                        ✕
                    </button>
                </div>
                    ...
                    {['apercu', 'voitures', 'reservations', 'clients', 'témoignages', 'parametres'].map(tab => (
                        <button
                            ...
                            className={`w-full flex items-center justify-start p-3 md:px-6 ${
                                activeTab === tab
                                    ? 'bg-red-50 text-#0986e9 dark:bg-gray-700 dark:text-red-400 border-l-4 border-#0986e9'
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                    <button
                        ...
                        className="w-full flex items-center justify-start p-2 text-gray-600 dark:text-gray-400 hover:text-#0986e9"
                    >
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="relative hidden md:block">
                                ...
                                <input
                                    ...
                                    className="pl-8 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9"
                                />
                            </div>
                    ...
                    <div className="mt-4 md:hidden">
                        <div className="relative">
                            ...
                            <input
                                ...
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                                className="w-full pl-8 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9"
                            />
                        </div>
                    </div>
                </header>
                ...
                <main className="p-4 sm:p-6">
                    {isLoading ? (
                        <div className="flex items-center justify-center h-64">
                            <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-#0986e9"></div>
                        </div>
                    ) : (
                        <>
                            {activeTab === 'apercu' && (
                                        ...
                                        <div className="bg-white dark:bg-gray-800 p-2 md:p-4 rounded-lg shadow-sm">
                                            <div className="flex items-center">
                                                <div className="rounded-full p-2 bg-red-100 dark:bg-red-900">
                                                    <Calendar className="h-4 w-4 md:h-6 md:w-6 text-#0986e9 dark:text-red-300" />
                                                </div>
                                                <div className="ml-2 md:ml-4">
                            ...
                            {activeTab === 'voitures' && (
                                <div>
                                    <div className="flex justify-end mb-2 md:mb-4">
                                        <button onClick={() => setShowAddModal('car')} className="flex items-center bg-#0986e9 hover:bg-red-600 text-white px-2 py-1 md:px-4 md:py-2 rounded-lg text-sm md:text-base">
                                            ...
                                            {filteredCars.map(car => (
                                                <tr key={car.id} className="border-b dark:border-gray-700">
                                                    ...
                                                    <td className="py-3 px-4 text-right">
                                                        ...
                                                        <button onClick={() => setShowConfirmDelete({ type: 'car', id: car.id })} className="text-#0986e9 hover:text-red-700">
                            ...
                            {activeTab === 'reservations' && (
                                <div>
                                    <div className="flex justify-end mb-2 md:mb-4">
                                        <button onClick={() => setShowAddModal('reservation')} className="flex items-center bg-#0986e9 hover:bg-red-600 text-white px-2 py-1 md:px-4 md:py-2 rounded-lg text-sm md:text-base">
                                            <Plus className="h-4 w-4 mr-1 md:mr-2" /> Ajouter
                                        </button>
                                    </div>
                                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-x-auto">
                                            ...
                                            {filteredReservations.map(reservation => (
                                                <tr key={reservation.id} className="border-b dark:border-gray-700">
                                                    ...
                                                    <td className="py-3 px-4 text-right">
                                                        ...
                                                        <button onClick={() => setShowConfirmDelete({ type: 'reservation', id: reservation.id })} className="text-#0986e9 hover:text-red-700">
                                                            <Trash className="h-4 w-4" />
                                                        </button>
                                                    </td>
                                                </tr>
                            ...
                            {activeTab === 'clients' && (
                                <div>
                                    <div className="flex justify-end mb-2 md:mb-4">
                                        <button onClick={() => setShowAddModal('customer')} className="flex items-center bg-#0986e9 hover:bg-red-600 text-white px-2 py-1 md:px-4 md:py-2 rounded-lg text-sm md:text-base">
                                            <Plus className="h-4 w-4 mr-1 md:mr-2" /> Ajouter
                                        </button>
                                    </div>
                                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-x-auto">
                                            ...
                                            {filteredCustomers.map(customer => (
                                                <tr key={customer.id} className="border-b dark:border-gray-700">
                                                    ...
                                                    <td className="py-3 px-4 text-right">
                                                        ...
                                                        <button onClick={() => setShowConfirmDelete({ type: 'customer', id: customer.id })} className="text-#0986e9 hover:text-red-700">
                                                            <Trash className="h-4 w-4" />
                                                        </button>
                                                    </td>
                                                </tr>
                            ...
                            {activeTab === 'témoignages' && (
                                <div>
                                    <div className="flex justify-end mb-2 md:mb-4">
                                        <button onClick={() => setShowAddModal('testimonial')} className="flex items-center bg-#0986e9 hover:bg-red-600 text-white px-2 py-1 md:px-4 md:py-2 rounded-lg text-sm md:text-base">
                                            <Plus className="h-4 w-4 mr-1 md:mr-2" /> Ajouter
                                        </button>
                                    </div>
                                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-x-auto">
                                            ...
                                            {filteredTestimonials.map(t => (
                                                <tr key={t.id} className="border-b dark:border-gray-700">
                                                    ...
                                                    <td className="py-3 px-4 text-right">
                                                        ...
                                                        <button onClick={() => setShowConfirmDelete({ type: 'testimonial', id: t.id })} className="text-#0986e9 hover:text-red-700">
                                                            <Trash className="h-4 w-4" />
                                                        </button>
                                                    </td>
                                                </tr>
                                ...
                                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 md:p-6">
                                    ...
                                    <form onSubmit={handleSettingsSubmit} className="space-y-4">
                                        <div>
                                            ...
                                            <input name="siteName" type="text" defaultValue={settings.siteName || 'AutoBenmohamed'} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            <label className="block text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Téléphone</label>
                                            <input name="phone" type="number" defaultValue={settings.phone || '21260000'} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            <label className="block text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email de contact</label>
                                            <input name="contactEmail" type="email" defaultValue={settings.contactEmail || 'reservation@AutoBenmohamed.ma'} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            <label className="block text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Facebook</label>
                                            <input name="facebook" type="url" defaultValue={settings.facebook || 'https://www.facebook.com'} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            <label className="block text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Instagram</label>
                                            <input name="instagram" type="url" defaultValue={settings.instagram || 'https://instagram.com'} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            <label className="block text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Adresse</label>
                                            <input name="adress" type="text" defaultValue={settings.adress || 'adresse XXXX, Maroc'} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            <label className="block text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Lien GPS</label>
                                            <input name="gps" type="url" defaultValue={settings.gps || ''} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            <label className="block text-xs md:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nouveau mot de passe :</label>
                                            <input name="password" type="password" defaultValue={settings.password ||''} className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div>
                                            ...
                                            <input name="confirmPassword" type="password" className="w-full px-2 py-1 md:px-3 md:py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-#0986e9" required />
                                        </div>
                                        <div className="flex items-center">
                                            ...
                                            <input name="maintenanceMode" type="checkbox" defaultChecked={settings.maintenanceMode || false} className="h-4 w-4 text-red-600 focus:ring-#0986e9 border-gray-300 dark:border-gray-600 rounded" />
                                        </div>
                                        <div className="flex justify-end">
                                            <button type="submit" className="px-2 py-1 md:px-4 md:py-2 bg-#0986e9 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-#0986e9 text-sm md:text-base">Enregistrer</button>
                                        </div>
                                    </form>
                                </div>
                            )}
                        ...
                        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full mx-2">
                            <form onSubmit={(e) => {
                                ...
                                <div className="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    <button type="submit" className="w-full sm:w-auto px-4 py-2 bg-#0986e9 text-white rounded-md hover:bg-red-600">{editingItem ? 'Modifier' : 'Ajouter'}</button>
                        ...
                        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full mx-2">
                            <form onSubmit={(e) => {
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-#0986e9"
                                                required
                                            >
                                ...
                                <div className="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    <button
                                        type="submit"
                                        className="w-full sm:w-auto px-4 py-2 bg-#0986e9 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-#0986e9"
                                    >
                        ...
                        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full mx-2">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button
                                    ...
                                    className="w-full sm:w-auto px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-#0986e9"
                                >
                                    Supprimer
                                </button>
                                <button
